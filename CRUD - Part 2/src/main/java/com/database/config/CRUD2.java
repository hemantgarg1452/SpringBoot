...
public class CRUD2 {
	...
	public static void main(String[] args) {
		ApplicationContext context = SpringApplication.run(CRUD2.class, args);
		...
		//Saving sinle object
		Customer Invoice = repo.save(customer1);

		//Saving Multiple objects using list
		List<Customer>resultSet = List.of(customer2, customer3);
		...
		//---------------------Custom find method in CRUD 2-----------------------------------

		List<Customer> res = repo.findByName("Jesica Grov");

		res.forEach(System.out::println);

		System.out.println("~~~~~~~~~~~~~~~~~");

		List<Customer> list = repo.findByNameAndCity("Alex Standyol", "New York");
		list.forEach(System.out::println);

		System.out.println();

		// There are many support keywords to create our own custom methods at Spring documentation:
		// Link: https://docs.spring.io/spring-data/jpa/reference/repositories/query-keywords-reference.html
